...
const header = () => {
  return (
      ...
      <header className="container mx-auto lg:max-w flex items-center justify-between bg-gray-500">
    ...
    <div class="container mx-auto flex flex-wrap items-center justify-between">
     ...
     <Image src="/logo.png" alt="drone logo" width="50" height="50"/>
       ...
       <a href="/" class="flex">
        ...
        <ul class="flex-col md:flex-row flex justify-end md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
        <li>
